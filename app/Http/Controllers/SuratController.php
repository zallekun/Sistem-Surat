 ...
 * Replace the entire staffIndex() method with this corrected version
 */
public function staffIndex()
{
    ...
    // Allow both staff_prodi and kaprodi to access this
