            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <form method="GET" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select name="action" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                                ...
                                <option value="force_complete" {{ request('action') == 'force_complete' ? 'selected' : '' }}>Force Complete</option>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('admin.audit-trail.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm font-medium">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($logs as $log)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex items-center">
                                            <div class="h-8 w-8 bg-blue-100 rounded-full flex items-center justify-center mr-2">
                                                <span class="text-blue-600 text-xs font-semibold">{{ substr($log->user->nama ?? 'U', 0, 2) }}</span>
                                            </div>
                                            <span class="text-gray-900">{{ $log->user->nama ?? 'Unknown' }}</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        @php
                                        ...
                                        @endphp
                                        <span class="px-2 py-1 text-xs font-medium rounded-full {{ $actionBadge['bg'] }} {{ $actionBadge['text'] }}">
                                            {{ $actionBadge['label'] }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-600 max-w-md truncate" title="{{ $log->reason }}">
