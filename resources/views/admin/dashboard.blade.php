    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-4 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($stats['total_pengajuan']) }}</p>
                    </div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-4 border-l-4 border-yellow-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($stats['pengajuan_pending']) }}</p>
                    </div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-4 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($stats['pengajuan_completed']) }}</p>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-4 border-l-4 border-red-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($stats['pengajuan_rejected']) }}</p>
                        <p class="text-xs text-gray-500 mt-0.5">Bulan ini</p>
                    </div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-4 border-l-4 border-orange-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($stats['pengajuan_stuck']) }}</p>
                    </div>
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-4 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-600 mt-1">{{ $stats['avg_processing_hours'] ?? 0 }} jam</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-6">
                ...
                <div style="height: 250px;"> {{-- ✅ TAMBAH WRAPPER --}}
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm p-6 mb-6">
            ...
            <div style="height: 300px;"> {{-- ✅ TAMBAH WRAPPER --}}
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-sm">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.pengajuan.index') }}" class="text-sm text-blue-600 hover:text-blue-800">
                            Lihat Semua →
                        </a>
                    </div>
                </div>
                                ...
                                <div class="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                                    <div class="flex-1">
                                        <p class="text-sm font-medium text-gray-900">
                                            {{ $pengajuan->mahasiswa->nama ?? $pengajuan->nama_mahasiswa }}
                                        </p>
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-orange-50">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-orange-500 text-white">
                            {{ $stuckPengajuan->count() }}
                        </span>
                    </div>
                </div>
                <div class="p-6">
                    @if($stuckPengajuan->count() > 0)
                        <div class="space-y-3">
                            @foreach($stuckPengajuan as $pengajuan)
                                <div class="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                                    <div class="flex-1">
                                        <p class="text-sm font-medium text-gray-900">
                                            {{ $pengajuan->mahasiswa->nama ?? $pengajuan->nama_mahasiswa }}
                                        ...
                                        <p class="text-xs text-gray-500 mt-0.5">
                                            {{ $pengajuan->prodi->nama_prodi ?? 'N/A' }} •
                                            Stuck {{ $pengajuan->updated_at->diffInDays(now()) }} hari
                                        </p>
                                    </div>
                                    <a href="{{ route('admin.pengajuan.show', $pengajuan->id) }}" 
