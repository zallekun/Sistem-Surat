...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-full mx-auto">
        <div class="bg-white/95 backdrop-blur-sm shadow-sm rounded-xl overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-0.5">{{ Auth::user()->prodi->nama_prodi ?? 'Program Studi' }}</p>
                    </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <form method="GET" action="{{ route('staff.arsip.index') }}" class="space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('staff.arsip.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm font-medium transition">
                                <i class="fas fa-redo mr-1"></i>Reset
                            </a>
                        </div>
                        
                        <!-- Export Button -->
                        <a href="{{ route('staff.arsip.export', request()->all()) }}" 
                    ...
                    <!-- Applied Filters -->
                    @if(request()->hasAny(['search', 'jenis_surat_id', 'date_from', 'date_to']))
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    @if(request('search'))
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            "{{ request('search') }}"
                                            <a href="{{ route('staff.arsip.index', request()->except('search')) }}" class="ml-1.5 hover:text-blue-900">×</a>
                                        </span>
                                    @endif
                                    ...
                                    @if(request('jenis_surat_id'))
                                        ...
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                            ...
                                            <a href="{{ route('staff.arsip.index', request()->except('jenis_surat_id')) }}" class="ml-1.5 hover:text-green-900">×</a>
                                        </span>
                                    @endif
                                    ...
                                    @if(request('date_from') || request('date_to'))
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                            ...
                                            <a href="{{ route('staff.arsip.index', request()->except(['date_from', 'date_to'])) }}" class="ml-1.5 hover:text-purple-900">×</a>
                                        </span>
                                    @endif
                                </div>
                                
                                <a href="{{ route('staff.arsip.index') }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                                    Hapus semua
                                </a>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-blue-50">
                                            ...
                                            <td class="px-4 py-4 w-40">
                                                <div class="flex items-center justify-center gap-2">
                                                    <a href="{{ route('staff.arsip.show', $pengajuan->id) }}" 
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <p class="text-gray-500 text-sm">
                        @if(request()->hasAny(['search', 'jenis_surat_id', 'date_from', 'date_to']))
                            Coba ubah filter atau <a href="{{ route('staff.arsip.index') }}" class="text-blue-600 hover:text-blue-800 font-medium">reset pencarian</a>
                        @else
