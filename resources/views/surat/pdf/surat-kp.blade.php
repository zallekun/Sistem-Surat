    ...
    <div class="content">
        ...
        <ol>
            <li>
                ...
                Nomor: {{ $displayData['nomor_nota'] ?? 'B-53/IF-FSI/VI/2025' }}
            ...
            <li>
                ...
                @if(isset($displayData['periode_mulai']) && isset($displayData['periode_selesai']))
                    {{ date('d F Y', strtotime($displayData['periode_mulai'])) }} s.d. {{ date('d F Y', strtotime($displayData['periode_selesai'])) }}
                @elseif(isset($additionalData['kerja_praktek']['periode_mulai']) && isset($additionalData['kerja_praktek']['periode_selesai']))
