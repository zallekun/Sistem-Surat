                        ...
                        <div class="card-body space-y-3" style="max-height: 600px; overflow-y: auto;">
                            ...
                            <div>
                                ...
                                <select id="edit_status_mahasiswa" class="form-control" data-preview="preview_status_mahasiswa">
                                    <option value="Aktif" {{ ($additionalData['status_mahasiswa'] ?? 'Aktif') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="Tidak Aktif" {{ ($additionalData['status_mahasiswa'] ?? '') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    <option value="Cuti" {{ ($additionalData['status_mahasiswa'] ?? '') == 'Cuti' ? 'selected' : '' }}>Cuti</option>
                                    <option value="Non-Aktif" {{ ($additionalData['status_mahasiswa'] ?? '') == 'Non-Aktif' ? 'selected' : '' }}>Non-Aktif</option>
                                </select>
                            </div>
                            ...
                            @if($pengajuan->jenisSurat->kode_surat === 'KP')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="edit_kepada_alamat" class="form-control" rows="2" data-preview="preview_kepada_alamat">{{ $additionalData['kerja_praktek']['alamat_perusahaan'] ?? '' }}</textarea>
                                </div>
                                ...
                                <div id="mahasiswa-container-kp">
                                    ...
                                    @foreach($mahasiswaKP as $index => $mhs)
                                    <div class="mahasiswa-row-kp border border-gray-200 rounded p-2 mb-2" data-index="{{ $index }}">
                                        ...
                                        <input type="text" id="edit_mhs_{{ $index }}_nama" class="form-control mt-1" 
                                            placeholder="Nama Lengkap" value="{{ $mhs['nama'] ?? '' }}" 
                                            data-preview="preview_mhs_kp_{{ $index }}_nama">
                                        <input type="text" id="edit_mhs_{{ $index }}_nim" class="form-control mt-1" 
                                            placeholder="NIM" value="{{ $mhs['nim'] ?? '' }}" 
                                            data-preview="preview_mhs_kp_{{ $index }}_nim">
                                        <input type="text" id="edit_mhs_{{ $index }}_prodi" class="form-control mt-1" 
                                            placeholder="Program Studi" value="{{ $mhs['prodi'] ?? $pengajuan->prodi->nama_prodi }}" 
                                            data-preview="preview_mhs_kp_{{ $index }}_prodi">
                                    </div>
                                    @endforeach
                                </div>
                                ...
                                @if($pengajuan->jenisSurat->kode_surat === 'TA')
                                <h5 class="font-bold text-gray-900 mt-4 mb-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="edit_lokasi_penelitian" class="form-control" data-preview="preview_lokasi_penelitian"
                                        value="{{ $additionalData['tugas_akhir']['lokasi_penelitian'] ?? 'UNJANI' }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="edit_judul_ta" class="form-control" rows="3" data-preview="preview_judul_ta">{{ $additionalData['tugas_akhir']['judul_ta'] ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="edit_pembimbing1" class="form-control" data-preview="preview_pembimbing1"
                                        value="{{ $additionalData['tugas_akhir']['dosen_pembimbing1'] ?? '' }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="edit_pembimbing2" class="form-control" data-preview="preview_pembimbing2"
                                        value="{{ $additionalData['tugas_akhir']['dosen_pembimbing2'] ?? '' }}">
                                </div>
                                ...
                                <div id="mahasiswa-container-ta">
                                    ...
                                    @foreach($mahasiswaTA as $index => $mhs)
                                    <div class="mahasiswa-row-ta border border-gray-200 rounded p-2 mb-2" data-index="{{ $index }}">
                                        <div class="flex justify-between items-center mb-1">
                                            <small class="text-gray-600">Mahasiswa {{ $index + 1 }}</small>
                                            @if($index > 0)
                                        ...
                                        <input type="text" id="edit_mhs_ta_{{ $index }}_nama" class="form-control mt-1" 
                                            placeholder="Nama Lengkap" value="{{ $mhs['nama'] ?? '' }}" 
                                            data-preview="preview_mhs_ta_{{ $index }}_nama">
                                        <input type="text" id="edit_mhs_ta_{{ $index }}_nim" class="form-control mt-1" 
                                            placeholder="NIM" value="{{ $mhs['nim'] ?? '' }}" 
                                            data-preview="preview_mhs_ta_{{ $index }}_nim">
                                        <input type="text" id="edit_mhs_ta_{{ $index }}_prodi" class="form-control mt-1" 
                                            placeholder="Program Studi" value="{{ $mhs['prodi'] ?? $pengajuan->prodi->nama_prodi }}" 
                                            data-preview="preview_mhs_ta_{{ $index }}_prodi">
                                    </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="edit_nomor_nota_ta" class="form-control" data-preview="preview_nomor_nota_ta"
                                        value="B-54/{{ strtoupper($pengajuan->prodi->kode_prodi) }}-FSI/IX/2025">
                                </div>
                    ...
                    <div class="p-2 bg-gray-50">
                        <div class="a4-container">
                            ...
                            <div id="dynamic-content">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="preview_ttd_pangkat" class="editable-field" data-input="edit_ttd_pangkat">
                                                {{ $penandatangan['pangkat'] ?: 'PENATA MUDA TK.I – III/B' }}
                                                <span class="tooltip-edit">Klik untuk edit</span>
                                            </span>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <strong style="text-transform: uppercase;">
                                                <span id="preview_nama_mahasiswa" class="editable-field" data-input="edit_nama_mahasiswa">
                                                    {{ strtoupper($pengajuan->nama_mahasiswa) }}
                                                    <span class="tooltip-edit">Klik untuk edit</span>
                                                </span>
                                            </strong>
                                        </td>
                                ...
                                <table style="width: 100%; margin: 10px 0;">
                                    @if(isset($additionalData['orang_tua']['nama']) && !empty($additionalData['orang_tua']['nama']))
                                    <tr>
                                        <td style="width: 160px; padding: 2px 0;">Nama</td>
                                        <td style="width: 15px; text-align: center;">:</td>
                                        <td style="text-transform: uppercase;">
                                            <span id="preview_nama" class="editable-field" data-input="edit_nama">
                                                {{ strtoupper($additionalData['orang_tua']['nama']) }}
                                                <span class="tooltip-edit">Klik untuk edit</span>
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">:</td>
                                        <td>
                                            @if(isset($additionalData['orang_tua']['tempat_lahir']))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="preview_pangkat_golongan" class="editable-field" data-input="edit_pangkat_golongan">
                                                {{ $additionalData['orang_tua']['pangkat_golongan'] }}
                                                <span class="tooltip-edit">Klik untuk edit</span>
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="preview_pekerjaan" class="editable-field" data-input="edit_pekerjaan">
                                                {{ $additionalData['orang_tua']['pekerjaan'] }}
                                                <span class="tooltip-edit">Klik untuk edit</span>
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="preview_instansi" class="editable-field" data-input="edit_instansi">
                                                {{ $additionalData['orang_tua']['instansi'] }}
                                                <span class="tooltip-edit">Klik untuk edit</span>
                                            </span>
                                        </td>
                                    </tr>
                            ...
                            case('KP')
                                        ...
                                        <div style="margin-top: 20px;">
                                            ...
                                            <p style="margin: 5px 0;">
                                                <span id="preview_kepada_nama" class="editable-field" data-input="edit_kepada_nama">
                                                    {{ $additionalData['kerja_praktek']['nama_perusahaan'] ?? 'PT. [Nama Perusahaan]' }}
                                                    <span class="tooltip-edit">Klik untuk edit</span>
                                                </span>
                                            </p>
                                            <p style="margin: 5px 0;">
                                                <span id="preview_kepada_alamat" class="editable-field" data-input="edit_kepada_alamat">
                                                    {{ $additionalData['kerja_praktek']['alamat_perusahaan'] ?? '[Alamat Perusahaan]' }}
                                                    <span class="tooltip-edit">Klik untuk edit</span>
                                                </span>
                                            </p>
                                        </div>
                                    ...
                                    <ol style="margin-left: 20px; padding-left: 0;">
                                        ...
                                        <li style="margin-bottom: 15px;">
                                            ...
                                            <span id="preview_periode_kp" class="editable-field" data-input="edit_periode_kp">
                                                {{ isset($additionalData['kerja_praktek']['periode_mulai']) && isset($additionalData['kerja_praktek']['periode_selesai']) 
                                ...
                                @case('TA')
                                                    ...
                                                    <div style="margin-top: 20px;">
                                                        ...
                                                        <p style="margin: 5px 0;">
                                                            <span id="preview_lokasi_penelitian" class="editable-field" data-input="edit_lokasi_penelitian">
                                                                {{ $additionalData['tugas_akhir']['lokasi_penelitian'] ?? 'UNJANI' }}
                                                                <span class="tooltip-edit">Klik untuk edit</span>
                                                            </span>
                                                        </p>
                                                        <p style="margin: 5px 0;">
                                        ...
                                        <div style="text-align: justify; font-size: 11pt; line-height: 1.3; margin: 20px 0;">
                                            ...
                                            <ol style="margin-left: 20px; padding-left: 0;">
                                                <li style="margin-bottom: 15px;">
                                                    Dasar: Nota Dinas Ketua Program Studi {{ $pengajuan->prodi->nama_prodi }} 
                                                    Nomor: <span id="preview_nomor_nota_ta" class="editable-field" data-input="edit_nomor_nota_ta">
                                                        B-54/{{ strtoupper($pengajuan->prodi->kode_prodi) }}-FSI/IX/2025
                                                        <span class="tooltip-edit">Klik untuk edit</span>
                                                    </span> 
                                                    perihal Surat Pengantar.
                                                </li>
                                                ...
                                                <li style="margin-bottom: 15px;">
                                                    ...
                                                    <table id="mahasiswa-table-ta" style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                                                        ...
                                                        <tbody id="mahasiswa-table-body-ta">
                                                            ...
                                                            <tr>
                                                                <td style="border: 1px solid #000; padding: 8px; text-align: center;">{{ $index + 1 }}</td>
                                                                <td style="border: 1px solid #000; padding: 8px;">
                                                                    <span id="preview_mhs_ta_{{ $index }}_nama" class="editable-field" data-input="edit_mhs_ta_{{ $index }}_nama">
                                                                        {{ $mhs['nama'] ?? '' }}
                                                                        <span class="tooltip-edit">Klik untuk edit</span>
                                                                    </span>
                                                                </td>
                                                                <td style="border: 1px solid #000; padding: 8px; text-align: center;">
                                                                    <span id="preview_mhs_ta_{{ $index }}_nim" class="editable-field" data-input="edit_mhs_ta_{{ $index }}_nim">
                                                                        {{ $mhs['nim'] ?? '' }}
                                                                        <span class="tooltip-edit">Klik untuk edit</span>
                                                                    </span>
                                                                </td>
                                                                <td style="border: 1px solid #000; padding: 8px; text-align: center;">
                                                                    <span id="preview_mhs_ta_{{ $index }}_prodi" class="editable-field" data-input="edit_mhs_ta_{{ $index }}_prodi">
                                                                        {{ $mhs['prodi'] ?? $pengajuan->prodi->nama_prodi }}
                                                                        <span class="tooltip-edit">Klik untuk edit</span>
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <div style="margin-top: 15px;">
                                                        ...
                                                        "<span id="preview_judul_ta" class="editable-field" data-input="edit_judul_ta">
                                                            {{ $additionalData['tugas_akhir']['judul_ta'] ?? '[Judul TA]' }}
                                                            <span class="tooltip-edit">Klik untuk edit</span>
                                                        </span>"
                                                    </div>
                                                    ...
                                                    <div style="margin-top: 10px;">
                                                        ...
                                                        1. <span id="preview_pembimbing1" class="editable-field" data-input="edit_pembimbing1">
                                                            {{ $additionalData['tugas_akhir']['dosen_pembimbing1'] ?? '-' }}
                                                            <span class="tooltip-edit">Klik untuk edit</span>
                                                        </span><br>
                                                        2. <span id="preview_pembimbing2" class="editable-field" data-input="edit_pembimbing2">
                                                            {{ $additionalData['tugas_akhir']['dosen_pembimbing2'] ?? '-' }}
                                                            <span class="tooltip-edit">Klik untuk edit</span>
                                                        </span>
                                                    </div>
                                                </li>
...
function updateMahasiswaTableKP() {
    ...
    mahasiswaRows.forEach((row, index) => {
        ...
        const prodi = prodiInput ? prodiInput.value.trim() : '{{ $pengajuan->prodi->nama_prodi }}';
...
function addMahasiswaRowKP() {
    ...
    newRow.innerHTML = `
        ...
        <input type="text" id="edit_mhs_${newIndex}_prodi" class="form-control mt-1" 
               placeholder="Program Studi" value="{{ $pengajuan->prodi->nama_prodi }}" 
...
function rejectSurat() {
    ...
    if (confirm('Tolak surat ini?')) {
        ...
        .then(result => {
            alert(result.message);
            if (result.success) window.location.href = '{{ route("fakultas.surat.index") }}';
        });
    }
}
...
function addMahasiswaRowTA() {
    ...
    newRow.innerHTML = `
        ...
        <input type="text" id="edit_mhs_ta_${newIndex}_prodi" class="form-control mt-1" placeholder="Program Studi" value="{{ $pengajuan->prodi->nama_prodi }}" data-preview="preview_mhs_ta_${newIndex}_prodi">
    `;
