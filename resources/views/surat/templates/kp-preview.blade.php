{{-- resources/views/surat/templates/kp-preview.blade.php --}}
...
<table style="margin-bottom: 20px; width: 100%; font-size: 12pt;">
    <tr>
        ...
        <td><span id="preview_nomor_surat_kp" class="editable-field" data-input="edit_nomor_surat">{{ $nomorSurat }}<span class="tooltip-edit">Klik untuk edit</span></span></td>
    </tr>
    <tr>
        <td>Sifat</td>
        <td>:</td>
...
<div style="margin-bottom: 20px; font-size: 12pt;">
    ...
    <div style="margin-bottom: 2px;"><span id="preview_kepada_nama" class="editable-field" data-input="edit_kepada_nama">{{ $additionalData['kerja_praktek']['nama_perusahaan'] ?? 'HRD Perusahaan' }}<span class="tooltip-edit">Klik untuk edit</span></span></div>
    <div style="margin-bottom: 2px;"><span id="preview_kepada_alamat_1" class="editable-field" data-input="edit_kepada_alamat_1">{{ $additionalData['kerja_praktek']['alamat_perusahaan'] ?? 'Alamat Perusahaan' }}<span class="tooltip-edit">Klik untuk edit</span></span></div>
...
<div style="text-align: justify; font-size: 12pt; line-height: 1.5;">
    ...
    <p style="margin-bottom: 12px;">
        <span id="preview_paragraph_1" class="editable-field" data-input="edit_paragraph_1">
            Dasar : Nota Dinas Ketua Program Studi {{ $pengajuan->prodi->nama_prodi ?? 'Kimia' }} Nomor: ND/373KI-FSI/XI/2024 tanggal {{ date('d F Y') }} perihal Permohonan Surat Pengantar Kerja Praktik (KP).
    ...
    <p style="margin-bottom: 12px;">
        <span id="preview_paragraph_2" class="editable-field" data-input="edit_paragraph_2">
            ...
            <span id="preview_periode_mulai">{{ $additionalData['kerja_praktek']['periode_mulai'] ?? '14 Juli' }}</span> s.d 
            <span id="preview_periode_selesai">{{ $additionalData['kerja_praktek']['periode_selesai'] ?? '16 Agustus 2025' }}</span> 
            ...
            @if(isset($mahasiswa) && is_array($mahasiswa) && count($mahasiswa) > 0)
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000; padding: 6px 8px;">
                        <span id="preview_mhs_{{ $index }}_nama" class="editable-field" data-input="edit_mhs_{{ $index }}_nama">
                            {{ $mhs['nama'] ?? '' }}
                            <span class="tooltip-edit">Klik untuk edit</span>
                        </span>
                    </td>
                    <td style="border: 1px solid #000; padding: 6px 8px;">
                        <span id="preview_mhs_{{ $index }}_nim" class="editable-field" data-input="edit_mhs_{{ $index }}_nim">
                            {{ $mhs['nim'] ?? '' }}
                            <span class="tooltip-edit">Klik untuk edit</span>
                        </span>
                    </td>
                    <td style="border: 1px solid #000; padding: 6px 8px;">
                        <span id="preview_mhs_{{ $index }}_prodi" class="editable-field" data-input="edit_mhs_{{ $index }}_prodi">
                            {{ $mhs['prodi'] ?? '' }}
                            <span class="tooltip-edit">Klik untuk edit</span>
                        </span>
                    </td>
                ...
                @for($i = count($mahasiswa); $i < 5; $i++)
                <tr>
                    <td style="border: 1px solid #000; padding: 6px 8px; text-align: center;">{{ $i + 1 }}</td>
                    <td style="border: 1px solid #000; padding: 6px 8px;">
                        <span id="preview_mhs_{{ $i }}_nama" class="editable-field" data-input="edit_mhs_{{ $i }}_nama">
                            <span class="tooltip-edit">Klik untuk edit</span>
                        </span>
                    </td>
                    <td style="border: 1px solid #000; padding: 6px 8px;">
                        <span id="preview_mhs_{{ $i }}_nim" class="editable-field" data-input="edit_mhs_{{ $i }}_nim">
                            <span class="tooltip-edit">Klik untuk edit</span>
                        </span>
                    </td>
                    <td style="border: 1px solid #000; padding: 6px 8px;">
                        <span id="preview_mhs_{{ $i }}_prodi" class="editable-field" data-input="edit_mhs_{{ $i }}_prodi">
                            <span class="tooltip-edit">Klik untuk edit</span>
                        </span>
                    </td>
                </tr>
    ...
    <ol style="margin-left: 0; padding-left: 20px;">
        ...
        <li>
            <span id="preview_tembusan_2" class="editable-field" data-input="edit_tembusan_2">
                Ketua Program Studi {{ $pengajuan->prodi->nama_prodi ?? 'Kimia' }} FSI UNJANI
                <span class="tooltip-edit">Klik untuk edit</span>
            </span>
        </li>
    </ol>
