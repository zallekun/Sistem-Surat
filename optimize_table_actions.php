...
echo "=== OPTIMIZING TABLE WITH DIRECT ACTION BUTTONS ===\n\n";

// Backup
$backupDir = storage_path('backup_actions_' . date('Y-m-d_H-i-s'));
...
// Create optimized table with direct action buttons
$optimizedContent = '@extends(\'layouts.app\')
...
echo "✓ Optimized table with direct action buttons\n";

echo "\n=== OPTIMIZATIONS ===\n";
echo "1. ✓ Removed dropdown menu - direct action buttons\n";
echo "2. ✓ Reduced padding: px-2 for tighter spacing\n";
echo "3. ✓ Compact action buttons: w-7 h-7 (28px)\n";
echo "4. ✓ Minimal gap between buttons: gap-1 (4px)\n";
echo "5. ✓ Conditional rendering - only show relevant buttons\n";
echo "6. ✓ Tooltips on hover for clarity\n";
echo "7. ✓ Max 4 buttons visible (view, edit, approve, reject)\n";

echo "\n=== SPACE CALCULATION ===\n";
echo "Action column width:\n";
echo "- View button: 28px\n";
echo "- Edit button: 28px (conditional)\n";
echo "- Approve button: 28px (conditional)\n";
echo "- Reject button: 28px (conditional)\n";
echo "- Gaps: 4px each\n";
echo "Max total: ~120px (fits well)\n";
