...
<div id="approveModal" class="fixed inset-0 bg-black bg-opacity-60 hidden items-center justify-center z-[9999]">
...
<div id="rejectModal" class="fixed inset-0 bg-black bg-opacity-60 hidden items-center justify-center z-[9999]">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto" 
         onclick="event.stopPropagation()">
        <!-- Header -->
        <div class="sticky top-0 bg-white rounded-t-xl flex items-center justify-between p-6 border-b border-gray-200">
...
#approveModal.hidden > div,
#rejectModal.hidden > div {
...
#approveModal > div::-webkit-scrollbar,
#rejectModal > div::-webkit-scrollbar {
    width: 6px;
}

#approveModal > div::-webkit-scrollbar-track,
#rejectModal > div::-webkit-scrollbar-track {
    background: #f1f5f9;
    border-radius: 3px;
}

#approveModal > div::-webkit-scrollbar-thumb,
#rejectModal > div::-webkit-scrollbar-thumb {
    background: #cbd5e1;
    border-radius: 3px;
}

#approveModal > div::-webkit-scrollbar-thumb:hover,
#rejectModal > div::-webkit-scrollbar-thumb:hover {
    background: #94a3b8;
}
...
/* Action button fixes (keep existing styles) */
.action-button {
    opacity: 1 !important;
