<?php $__env->startSection('title', 'Edit Dosen Wali'); ?>
...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white shadow-sm rounded-xl overflow-hidden">
            ...
            <form action="<?php echo e(route('admin.dosen-wali.update', $dosenWali->id)); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" 
                               name="nama" 
                               value="<?php echo e(old('nama', $dosenWali->nama)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="nid" 
                               value="<?php echo e(old('nid', $dosenWali->nid)); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($p->id); ?>" <?php echo e(old('prodi_id', $dosenWali->prodi_id) == $p->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" 
                                   ...
                                   <?php echo e(old('is_active', $dosenWali->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-surat\resources\views/admin/master/dosen-wali/edit.blade.php ENDPATH**/ ?>