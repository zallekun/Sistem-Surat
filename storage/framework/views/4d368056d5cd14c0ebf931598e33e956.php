...
<head>
    <meta charset="utf-8">
    <title>Surat Permohonan Izin Kerja Praktek - <?php echo e($pengajuan->nim ?? 'Multiple'); ?></title>
    <style>
        @page {
            size: A4;
            margin: 15mm 20mm;
...
<body>
    ...
    <div class="document-info">
        <table>
            <tr>
                ...
                <td class="colon">:</td>
                <td><span class="" content="true"><?php echo e($displayData['nomor_surat'] ?? 'BI/FSI-UNJANI/XI/2024'); ?></span></td>
            </tr>
            <tr>
                <td>Sifat</td>
                <td>:</td>
                <td><span class="" content="true"><?php echo e($displayData['sifat'] ?? 'Biasa'); ?></span></td>
            </tr>
            <tr>
                <td>Lampiran</td>
                <td>:</td>
                <td><span class="" content="true"><?php echo e($displayData['lampiran'] ?? '-'); ?></span></td>
            </tr>
            <tr>
                <td>Perihal</td>
                <td>:</td>
                <td><strong><?php echo e($displayData['perihal'] ?? 'Permohonan Izin Melaksanakan Kerja Praktik'); ?></strong></td>
            </tr>
        </table>
    </div>
    ...
    <div class="recipient">
        <div class="recipient-line">
            Kepada: <span class="" content="true"><?php echo e($displayData['kepada_yth'] ?? 'Yth'); ?></span>
        </div>
        <div class="recipient-line">
            <span class="" content="true"><?php echo e($displayData['kepada_nama'] ?? $additionalData['kerja_praktek']['nama_perusahaan'] ?? 'Nama Perusahaan'); ?></span>
        </div>
        <div class="recipient-line">
            <span class="" content="true"><?php echo e($displayData['kepada_alamat_1'] ?? 'Alamat Baris 1'); ?></span>
        </div>
        <div class="recipient-line">
            <span class="" content="true"><?php echo e($displayData['kepada_alamat_2'] ?? 'Alamat Baris 2'); ?></span>
        </div>
        <div class="recipient-line">
            <span class="" content="true"><?php echo e($displayData['kepada_tempat'] ?? 'Di Tempat'); ?></span>
        </div>
    </div>

    <!-- Greeting -->
    <div style="margin-bottom: 15px;">
        <p><span class="" content="true"><?php echo e($displayData['salam_pembuka'] ?? 'Dengan hormat,'); ?></span></p>
    </div>
    ...
    <div class="content">
        <p>
            <span class="" content="true">
                <?php echo e($displayData['paragraph_1'] ?? 'Dasar : Nota Dinas Ketua Program Studi Kimia Nomor: ND/373KI-FSI/XI/2024 tanggal 20 November 2024 perihal Permohonan Surat Pengantar Kerja Praktik (KP).'); ?>
            ...
            <tbody>
                <?php if(isset($additionalData['kerja_praktek']['mahasiswa_kp']) && is_array($additionalData['kerja_praktek']['mahasiswa_kp'])): ?>
                    ...
                    <tr>
                        ...
                        <td class="nama"><span class="" content="true"><?php echo e($mhs['nama'] ?? ''); ?></span></td>
                        <td class="nim"><span class="" content="true"><?php echo e($mhs['nim'] ?? ''); ?></span></td>
                        <td class="prodi"><span class="" content="true"><?php echo e($mhs['prodi'] ?? ''); ?></span></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    
                    <!-- Add empty rows if less than 5 students for consistent formatting -->
                    <?php if(count($additionalData['kerja_praktek']['mahasiswa_kp']) < 5): ?>
                        <?php for($i = count($additionalData['kerja_praktek']['mahasiswa_kp']); $i < 5; $i++): ?>
                        <tr>
        ...
        <p>
            <span class="" content="true">
                <?php echo e($displayData['paragraph_3'] ?? 'Demikian surat permohonan ini kami sampaikan, atas perhatian dan kerjasamanya diucapkan terima kasih.'); ?>
    ...
    <div class="signature-area">
        <div class="signature-content">
            <p><span class="" content="true"><?php echo e($displayData['tempat_tanggal'] ?? ('Cimahi, ' . date('d F Y'))); ?></span></p>
            <p><span class="" content="true"><?php echo e($displayData['jabatan_penandatangan'] ?? 'An. Dekan'); ?></span></p>
            <p><span class="" content="true"><?php echo e($displayData['jabatan_wakil'] ?? 'Wakil Dekan I - FSI'); ?></span></p>
            
            <div class="signature-space">
                <?php if(isset($barcodeImage) && $barcodeImage): ?>
            ...
            <p class="name-underline"><span class="" content="true"><?php echo e($displayData['nama_penandatangan'] ?? $penandatangan['nama'] ?? 'Dr. Arie Handian, S.Si., M.Si'); ?></span></p>
            <p class="nid"><span class="" content="true"><?php echo e($displayData['nip_penandatangan'] ?? $penandatangan['nid'] ?? 'NIP. 4121 857 87'); ?></span></p>
        </div>
    </div>
    ...
    <div class="tembusan">
        ...
        <ol class="tembusan-list">
            <li><span class="" content="true"><?php echo e($displayData['tembusan_1'] ?? 'Dekan FSI (sebagai laporan)'); ?></span></li>
            <li><span class="" content="true"><?php echo e($displayData['tembusan_2'] ?? 'Ketua Program Studi ' . ($pengajuan->prodi->nama_prodi ?? 'Kimia') . ' FSI UNJANI'); ?></span></li>
        </ol>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            saveOriginalData();
            console.log('Surat KP loaded with', <?php echo e(count($additionalData['kerja_praktek']['mahasiswa_kp'] ?? [])); ?>, 'mahasiswa');
        });
        ...
        function saveDraft() {
            ...
            localStorage.setItem('surat_kp_draft_<?php echo e($pengajuan->id ?? "new"); ?>', JSON.stringify(data));
            alert('Draft berhasil disimpan!');
        }

        function loadDraft() {
            const saved = localStorage.getItem('surat_kp_draft_<?php echo e($pengajuan->id ?? "new"); ?>');
            if (saved) {
...
</html><?php /**PATH C:\laragon\www\sistem-surat\resources\views/surat/pdf/surat-kp.blade.php ENDPATH**/ ?>