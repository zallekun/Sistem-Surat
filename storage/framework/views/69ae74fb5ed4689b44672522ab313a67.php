...
<?php $__env->startSection('title', 'Generate Surat Pengantar'); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                ...
                                <div><strong>Prodi:</strong> <?php echo e($pengajuan->prodi->nama_prodi); ?></div>
                                <div><strong>Token:</strong> <?php echo e($pengajuan->tracking_token); ?></div>
                            </div>
                            
                            <div class="mt-3">
                                <a href="<?php echo e(route('staff.pengajuan.show', $pengajuan->id)); ?>" class="btn btn-outline w-full">
                        ...
                        <div class="card-body space-y-3" style="max-height: 600px; overflow-y: auto;">
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_dari" class="form-control" data-preview="preview_dari"
                                       value="Ketua Program Studi <?php echo e($pengajuan->prodi->nama_prodi); ?>">
                            </div>
                            ...
                            <ol style="list-style-type: lower-alpha; padding-left: 20px; margin: 0;">
                                <li style="margin-bottom: 12px;">
                                    ...
                                    <textarea id="edit_dasar_a" class="form-control" rows="2" data-preview="preview_dasar_a">Program Kerja Prodi <?php echo e($pengajuan->prodi->nama_prodi); ?> 2025, tentang Kalender Kegiatan Akademik Unjani TA. 2024/2025.</textarea>
                                </li>
                            ...
                            <div id="mahasiswa-container">
                                ...
                                <div class="mahasiswa-row border border-gray-200 rounded p-3 mb-2" data-index="<?php echo e($index); ?>">
                                    <div class="flex justify-between items-center mb-2">
                                        <small class="text-gray-600 font-medium">Mahasiswa <?php echo e($index + 1); ?></small>
                                        <?php if($index > 0): ?>
                                        <button type="button" onclick="removeMahasiswaRow(<?php echo e($index); ?>)" class="text-red-500 text-xs">
                                            <i class="fas fa-times"></i> Hapus
                                        </button>
                                        <?php endif; ?>
                                    </div>
                                    <div class="space-y-2">
                                        <input type="text" id="edit_mhs_<?php echo e($index); ?>_nim" class="form-control" 
                                               placeholder="NIM" 
                                               value="<?php echo e($mhs['nim'] ?? ''); ?>" 
                                               data-preview="preview_mhs_<?php echo e($index); ?>_nim">
                                        <input type="text" id="edit_mhs_<?php echo e($index); ?>_nama" class="form-control" 
                                               placeholder="Nama Lengkap" 
                                               value="<?php echo e($mhs['nama'] ?? ''); ?>" 
                                               data-preview="preview_mhs_<?php echo e($index); ?>_nama">
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_nama_instansi" class="form-control" data-preview="preview_nama_instansi"
                                       value="<?php echo e($additionalData['kerja_praktek']['nama_perusahaan'] ?? 'Badan Kesatuan Bangsa dan Politik Kota Cimahi (Bakesbangpol Cimahi)'); ?>">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Alamat Instansi</label>
                                <textarea id="edit_alamat_instansi" class="form-control" rows="3" data-preview="preview_alamat_instansi"><?php echo e($additionalData['kerja_praktek']['alamat_perusahaan'] ?? 'Gedung C, Jl. Raden Demang Hardjakusumah Lantai 1, Cibabat, Kec. Cimahi Utara, Kota Cimahi, Jawa Barat 40513'); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_tempat_tanggal" class="form-control" data-preview="preview_tempat_tanggal"
                                       value="Cimahi, <?php echo e($tanggalSurat); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_nama_ttd" class="form-control" data-preview="preview_nama_ttd"
                                       value="<?php echo e($kaprodi->nama ?? 'Taebir Hendro Pudjiantoro, S.Si., M.T'); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_nid_ttd" class="form-control" data-preview="preview_nid_ttd"
                                       value="<?php echo e($kaprodi->nip ?? '412166969'); ?>">
                            </div>
                ...
                <div class="card">
                    <div class="card-header no-print">
                        <h3 class="font-bold text-gray-900">
                            ...
                            Preview Nota Dinas <?php echo e($pengajuan->jenisSurat->nama_jenis); ?>
                    ...
                    <div class="p-2 bg-gray-50">
                        <div class="a4-container">
                            ...
                            <table style="width: 100%; border-collapse: collapse; border-bottom: 3px double #000; padding-bottom: 8px; margin-bottom: 12px;">
                                <tr>
                                    <td style="width: 15%; text-align: center; vertical-align: middle;">
                                        <img src="<?php echo e(asset('images/logo-ykep.png')); ?>" style="width: 60px; height: 60px;" alt="Logo YKEP">
                                    </td>
                                    <td style="width: 70%; text-align: center; font-weight: bold; line-height: 1.3; vertical-align: middle;">
                                        ...
                                        <div style="font-size: 14pt; font-weight: bold;">PROGRAM STUDI S1 <?php echo e(strtoupper($pengajuan->prodi->nama_prodi)); ?></div>
                                    ...
                                    <td style="width: 15%; text-align: center; vertical-align: middle;">
                                        <img src="<?php echo e(asset('images/logo-unjani.png')); ?>" style="width: 65px; height: 65px;" alt="Logo UNJANI">
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="text-align: center; margin: 20px 0;">
                                ...
                                <div style="margin-top: 8px;">Nomor : <span id="preview_nomor_nota" class="editable-field" data-input="edit_nomor_nota"><?php echo e($nomorSurat); ?><span class="tooltip-edit">Klik untuk edit</span></span></div>
                            </div>
                            ...
                            <div style="margin: 20px 0;">
                                <table style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px 0;"><span id="preview_dari" class="editable-field" data-input="edit_dari">Ketua Program Studi <?php echo e($pengajuan->prodi->nama_prodi); ?><span class="tooltip-edit">Klik untuk edit</span></span></td>
                                    </tr>
                                    <tr>
                            ...
                            <div style="text-align: justify; margin: 15px 0;">
                                    ...
                                    <li style="margin-bottom: 15px;">
                                        ...
                                        <ol type="a" style="margin-left: 20px; margin-top: 8px; padding-left: 0px; list-style-type: lower-alpha;">
                                            <li style="margin-bottom: 8px; text-align: justify;">
                                                <span id="preview_dasar_a" class="editable-field" data-input="edit_dasar_a">Program Kerja Prodi <?php echo e($pengajuan->prodi->nama_prodi); ?> 2025, tentang Kalender Kegiatan Akademik Unjani TA. 2024/2025.<span class="tooltip-edit">Klik untuk edit</span></span>
                                            </li>
                                            <li style="margin-bottom: 8px; text-align: justify;">
                                ...
                                <div style="margin: 20px 0; font-weight: bold;">
                                    <span id="preview_nama_instansi" class="editable-field" data-input="edit_nama_instansi"><?php echo e($additionalData['kerja_praktek']['nama_perusahaan'] ?? 'Badan Kesatuan Bangsa dan Politik Kota Cimahi (Bakesbangpol Cimahi)'); ?><span class="tooltip-edit">Klik untuk edit</span></span>
                                </div>
                                <div style="margin: 5px 0;">
                                    <span id="preview_alamat_instansi" class="editable-field" data-input="edit_alamat_instansi"><?php echo e($additionalData['kerja_praktek']['alamat_perusahaan'] ?? 'Gedung C, Jl. Raden Demang Hardjakusumah Lantai 1, Cibabat, Kec. Cimahi Utara, Kota Cimahi, Jawa Barat 40513'); ?><span class="tooltip-edit">Klik untuk edit</span></span>
                                </div>
                            ...
                            <div style="margin-top: 40px; text-align: right;">
                                <div style="display: inline-block; text-align: center; min-width: 200px;">
                                    <p><span id="preview_tempat_tanggal" class="editable-field" data-input="edit_tempat_tanggal">Cimahi, <?php echo e($tanggalSurat); ?><span class="tooltip-edit">Klik untuk edit</span></span></p>
                                    ...
                                    <p><span id="preview_unit_ttd" class="editable-field" data-input="edit_unit_ttd"><?php echo e($pengajuan->prodi->nama_prodi); ?><span class="tooltip-edit">Klik untuk edit</span></span></p>
                                    <div style="height: 60px; margin: 10px 0;" id="ttd-preview-space">
                                        <!-- TTD will appear here after upload -->
                                    </div>
                                    <p style="text-decoration: underline; font-weight: bold;"><span id="preview_nama_ttd" class="editable-field" data-input="edit_nama_ttd"><?php echo e($kaprodi->nama ?? 'Taebir Hendro Pudjiantoro, S.Si., M.T'); ?><span class="tooltip-edit">Klik untuk edit</span></span></p>
                                    <p>NID. <span id="preview_nid_ttd" class="editable-field" data-input="edit_nid_ttd"><?php echo e($kaprodi->nip ?? '412166969'); ?><span class="tooltip-edit">Klik untuk edit</span></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
let mahasiswaCount = <?php echo e(count($mahasiswaList ?? [])); ?>;
...
function generateSuratPengantar() {
    ...
    // Submit via AJAX
    fetch('<?php echo e(route("staff.pengajuan.pengantar.store", $pengajuan->id)); ?>', {
        method: 'POST',
        headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-surat\resources\views/staff/pengajuan/preview-pengantar.blade.php ENDPATH**/ ?>