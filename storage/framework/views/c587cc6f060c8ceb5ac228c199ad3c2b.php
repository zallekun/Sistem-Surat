...
<div class="bg-white shadow-sm rounded-xl overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('admin.prodi.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium transition">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <form method="GET" class="flex gap-4">
                    ...
                    <div class="w-64">
                        <select name="fakultas_id" class="w-full px-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            ...
                            <?php $__currentLoopData = $fakultas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($f->id); ?>" <?php echo e(request('fakultas_id') == $f->id ? 'selected' : ''); ?>>
                    ...
                    <a href="<?php echo e(route('admin.prodi.index')); ?>" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm font-medium">
            ...
            <?php if($prodis->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($prodis->firstItem() + $index); ?></td>
                                    <td class="px-6 py-4 text-sm">
                                        <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded font-mono text-xs"><?php echo e($prodi->kode_prodi); ?></span>
                                    </td>
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($prodi->nama_prodi); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($prodi->fakultas->nama_fakultas ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-center">
                                        <span class="px-2 py-1 bg-gray-100 text-gray-800 rounded text-xs"><?php echo e($prodi->users()->count()); ?></span>
                                    </td>
                ...
                <div class="px-6 py-4 border-t">
                    <?php echo e($prodis->appends(request()->query())->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rezal-suryadi-putra/Documents/KULIAH/SEMESTER 7/KP/sistem-surat/resources/views/admin/master/prodi/index.blade.php ENDPATH**/ ?>