                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <?php if(Auth::user()->hasRole('admin')): ?>
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-blue-50 hover:border-blue-200 border-2 border-transparent transition">
                        ...
                        <?php if(Auth::user()->hasRole('staff_fakultas')): ?>
                            <a href="<?php echo e(route('fakultas.surat.index')); ?>" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 border-2 border-blue-200 transition">
                                <svg class="h-8 w-8 text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <?php if(Auth::user()->hasRole('staff_prodi') || in_array(Auth::user()->jabatan?->nama_jabatan, ['Staff Program Studi'])): ?>
                            ...
                            <a href="<?php echo e(route('staff.pengajuan.index')); ?>" class="relative flex flex-col items-center justify-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 border-2 border-orange-200 transition">
                                ...
                                <?php if(isset($stats['pengajuan_pending']) && $stats['pengajuan_pending'] > 0): ?>
                                    <span class="absolute top-2 right-2 px-2 py-0.5 text-xs rounded-full bg-red-500 text-white font-semibold">
                                        <?php echo e($stats['pengajuan_pending']); ?>
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-blue-50 hover:border-blue-200 border-2 border-transparent transition">
                            <svg class="h-8 w-8 text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                        <div>
                            <p class="text-sm font-medium text-gray-900"><?php echo e($pengajuan->nama_mahasiswa); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rezal-suryadi-putra/Documents/KULIAH/SEMESTER 7/KP/sistem-surat/resources/views/dashboard/index.blade.php ENDPATH**/ ?>