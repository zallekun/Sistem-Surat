...
<?php $__env->startSection('title', 'Arsip Surat Fakultas'); ?>
...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-full mx-auto">
        <div class="bg-white/95 backdrop-blur-sm shadow-sm rounded-xl overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <form method="GET" action="<?php echo e(route('fakultas.arsip.index')); ?>" class="space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex gap-2">
                            ...
                            <a href="<?php echo e(route('fakultas.arsip.index')); ?>" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm font-medium transition">
                                <i class="fas fa-redo mr-1"></i>Reset
                            </a>
                        </div>
                        
                        <!-- Export Button -->
                        <a href="<?php echo e(route('fakultas.arsip.export', request()->all())); ?>" 
                    ...
                    <!-- Applied Filters -->
                    <?php if(request()->hasAny(['search', 'prodi_id', 'jenis_surat_id', 'date_from', 'date_to'])): ?>
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <?php if(request('search')): ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            ...
                                            <a href="<?php echo e(route('fakultas.arsip.index', request()->except('search'))); ?>" class="ml-1.5 hover:text-blue-900">×</a>
                                        </span>
                                    <?php endif; ?>
                                    ...
                                    <?php if(request('prodi_id')): ?>
                                        ...
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                            ...
                                            <a href="<?php echo e(route('fakultas.arsip.index', request()->except('prodi_id'))); ?>" class="ml-1.5 hover:text-green-900">×</a>
                                        </span>
                                    <?php endif; ?>
                                    ...
                                    <?php if(request('jenis_surat_id')): ?>
                                        ...
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                            ...
                                            <a href="<?php echo e(route('fakultas.arsip.index', request()->except('jenis_surat_id'))); ?>" class="ml-1.5 hover:text-purple-900">×</a>
                                        </span>
                                    <?php endif; ?>
                                    ...
                                    <?php if(request('date_from') || request('date_to')): ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                            ...
                                            <a href="<?php echo e(route('fakultas.arsip.index', request()->except(['date_from', 'date_to']))); ?>" class="ml-1.5 hover:text-orange-900">×</a>
                                        </span>
                                    <?php endif; ?>
                                </div>
                                
                                <a href="<?php echo e(route('fakultas.arsip.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                                    Hapus semua
                                </a>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-blue-50">
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <div class="flex items-center justify-center gap-2">
                                                    <a href="<?php echo e(route('fakultas.arsip.show', $pengajuan->id)); ?>" 
            ...
            <?php else: ?>
                ...
                <div class="text-center py-16">
                    ...
                    <p class="text-gray-500 text-sm">
                        <?php if(request()->hasAny(['search', 'prodi_id', 'jenis_surat_id', 'date_from', 'date_to'])): ?>
                            Coba ubah filter atau <a href="<?php echo e(route('fakultas.arsip.index')); ?>" class="text-blue-600 hover:text-blue-800 font-medium">reset pencarian</a>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-surat\resources\views/fakultas/arsip/index.blade.php ENDPATH**/ ?>