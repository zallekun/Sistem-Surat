                    ...
                    <div class="card">
                        ...
                        <div class="card-body space-y-3" style="max-height: 600px; overflow-y: auto;">
                            ...
                            <div>
                                ...
                                <textarea id="edit_kepada_alamat_1" class="form-control" rows="2" data-preview="preview_kepada_alamat_1"><?php echo e($additionalData['kerja_praktek']['alamat_perusahaan'] ?? ''); ?></textarea>
                            </div>
                            ...
                            <?php if(isset($additionalData['kerja_praktek']['mahasiswa_kp'])): ?>
                                ...
                                <div class="border border-gray-200 rounded p-2 mb-2">
                                    ...
                                    <input type="text" id="edit_mhs_<?php echo e($index); ?>_nama" class="form-control mt-1" 
                                           placeholder="Nama" value="<?php echo e($mhs['nama'] ?? ''); ?>" data-preview="preview_mhs_<?php echo e($index); ?>_nama">
                                    <input type="text" id="edit_mhs_<?php echo e($index); ?>_nim" class="form-control mt-1" 
                                           placeholder="NIM" value="<?php echo e($mhs['nim'] ?? ''); ?>" data-preview="preview_mhs_<?php echo e($index); ?>_nim">
                                    <input type="text" id="edit_mhs_<?php echo e($index); ?>_prodi" class="form-control mt-1" 
                                           placeholder="Program Studi" value="<?php echo e($mhs['prodi'] ?? ''); ?>" data-preview="preview_mhs_<?php echo e($index); ?>_prodi">
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>

                            <!-- Add 5 mahasiswa fields for KP even if not filled -->
                            <?php for($i = (isset($additionalData['kerja_praktek']['mahasiswa_kp']) ? count($additionalData['kerja_praktek']['mahasiswa_kp']) : 0); $i < 5; $i++): ?>
                            <div class="border border-gray-200 rounded p-2 mb-2">
                                <small class="text-gray-600">Mahasiswa <?php echo e($i + 1); ?></small>
                                <input type="text" id="edit_mhs_<?php echo e($i); ?>_nama" class="form-control mt-1" 
                                       placeholder="Nama" value="" data-preview="preview_mhs_<?php echo e($i); ?>_nama">
                                <input type="text" id="edit_mhs_<?php echo e($i); ?>_nim" class="form-control mt-1" 
                                       placeholder="NIM" value="" data-preview="preview_mhs_<?php echo e($i); ?>_nim">
                                <input type="text" id="edit_mhs_<?php echo e($i); ?>_prodi" class="form-control mt-1" 
                                       placeholder="Program Studi" value="" data-preview="preview_mhs_<?php echo e($i); ?>_prodi">
                            </div>
                            <?php endfor; ?>
                            ...
                            <div>
                                ...
                                <textarea id="edit_paragraph_1" class="form-control" rows="2" data-preview="preview_paragraph_1">Dasar : Nota Dinas Ketua Program Studi <?php echo e($pengajuan->prodi->nama_prodi ?? 'Kimia'); ?> Nomor: ND/373KI-FSI/XI/2024 tanggal <?php echo e(date('d F Y')); ?> perihal Permohonan Surat Pengantar Kerja Praktik (KP).</textarea>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Paragraph 2 (Isi)</label>
                                <textarea id="edit_paragraph_2" class="form-control" rows="3" data-preview="preview_paragraph_2">Atas dasar tersebut di atas, bersama ini kami sampaikan permohonan Izin untuk melaksanakan Kerja Praktik pada tanggal <?php echo e($additionalData['kerja_praktek']['periode_mulai'] ?? '14 Juli'); ?> s.d <?php echo e($additionalData['kerja_praktek']['periode_selesai'] ?? '16 Agustus 2025'); ?> di Instansi/Perusahaan yang Bapak/Ibu Pimpin kepada mahasiswa sebagai berikut :</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_tembusan_2" class="form-control" data-preview="preview_tembusan_2"
                                       value="Ketua Program Studi <?php echo e($pengajuan->prodi->nama_prodi ?? 'Kimia'); ?> FSI UNJANI">
                            </div>
                            <?php endif; ?>
                    ...
                    <div class="p-2 bg-gray-50">
                        <div class="a4-container">
                            ...
                            <div id="dynamic-content">
                                <?php switch($pengajuan->jenisSurat->kode_surat):
                                    case ('MA'): ?>
                                        <?php echo $__env->make('surat.templates.ma-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        <?php break; ?>
                                    <?php case ('KP'): ?>
                                        <?php echo $__env->make('surat.templates.kp-preview', [
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const additionalData = <?php echo $allAdditionalData; ?>;
