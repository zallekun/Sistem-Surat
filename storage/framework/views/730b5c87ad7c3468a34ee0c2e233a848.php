...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                ...
                <p class="text-white opacity-100">
                    ...
                    ?>
                    <span class="font-medium"><?php echo e($roleName); ?></span>
                    <?php if(Auth::user()->jabatan): ?>
                        • <?php echo e(Auth::user()->jabatan->deskripsi ?? ucfirst(str_replace('_', ' ', Auth::user()->jabatan->nama_jabatan))); ?>

                    <?php endif; ?>
                    <?php if(Auth::user()->prodi): ?>
                        • <?php echo e(Auth::user()->prodi->nama_prodi); ?>
        ...
        <!-- Statistics Cards -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-<?php echo e(Auth::user()->hasRole(['staff_prodi', 'staff_fakultas']) ? '5' : '4'); ?> gap-4 mb-6">
            <!-- Card 1: Total Surat -->
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">
                                    <?php echo e($stats['total_surat'] ?? 0); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">
                                    <?php echo e($stats['surat_selesai'] ?? 0); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">
                                    <?php echo e($stats['surat_proses'] ?? 0); ?>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">
                                    <?php if(Auth::user()->hasRole('admin') || in_array(Auth::user()->jabatan?->nama_jabatan, ['dekan', 'wd1', 'wd2', 'wd3'])): ?>
                                        Disposisi
                                    <?php else: ?>
                                        Draft
                                    <?php endif; ?>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">
                                    <?php echo e($stats['surat_draft'] ?? 0); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">
                                    <?php echo e($stats['pengajuan_fakultas_pending'] ?? 0); ?>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <?php if(Auth::user()->hasRole('admin')): ?>
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                        ...
                        <?php if(Auth::user()->hasRole('staff_fakultas')): ?>
                            <a href="<?php echo e(route('fakultas.surat.index')); ?>" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                        ...
                        <?php if(Auth::user()->hasRole('staff_prodi') || in_array(Auth::user()->jabatan?->nama_jabatan, ['Staff Program Studi', 'Staff Fakultas'])): ?>
                            <a href="<?php echo e(route('staff.surat.create')); ?>" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                                <svg class="h-6 w-6 text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php if(Auth::user()->hasRole('staff_prodi')): ?>
                            <a href="<?php echo e(route('staff.pengajuan.index')); ?>" class="flex flex-col items-center justify-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition">
                                ...
                                <?php if(isset($stats['pengajuan_pending']) && $stats['pengajuan_pending'] > 0): ?>
                                    <span class="mt-1 px-2 py-1 text-xs rounded-full bg-red-100 text-red-800">
                                        <?php echo e($stats['pengajuan_pending']); ?> baru
                                    </span>
                                <?php endif; ?>
                            </a>
                        <?php endif; ?>
                        
                        <?php if(Auth::user()->hasRole('kaprodi') || Auth::user()->jabatan?->nama_jabatan == 'Kepala Program Studi'): ?>
                            <a href="<?php echo e(route('kaprodi.surat.approval')); ?>" class="flex flex-col items-center justify-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
                            ...
                            <a href="<?php echo e(route('surat.index')); ?>" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                                <svg class="h-6 w-6 text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <?php if(in_array(Auth::user()->jabatan?->nama_jabatan, ['dekan', 'wd1', 'wd2', 'wd3'])): ?>
                            <a href="<?php echo e(route('pimpinan.surat.disposisi')); ?>" class="flex flex-col items-center justify-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                            ...
                            <a href="<?php echo e(route('pimpinan.surat.ttd')); ?>" class="flex flex-col items-center justify-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition">
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                            <svg class="h-6 w-6 text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if(Auth::user()->hasRole('staff_prodi') && isset($recent_pengajuan) && $recent_pengajuan && $recent_pengajuan->count() > 0): ?>
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Pengajuan Surat Terbaru</h3>
                    <a href="<?php echo e(route('staff.pengajuan.index')); ?>" class="text-sm text-blue-600 hover:text-blue-900">
                        Lihat semua →
                    </a>
                </div>
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between py-2 border-b">
                        <div>
                            <p class="text-sm font-medium"><?php echo e($pengajuan->nama_mahasiswa); ?></p>
                            <p class="text-xs text-gray-500">
                                <?php echo e($pengajuan->nim); ?> • <?php echo e($pengajuan->jenis_surat ?? 'Pengajuan Surat'); ?> • <?php echo e($pengajuan->created_at->diffForHumans()); ?>

                            </p>
                        </div>
                        <form action="<?php echo e(route('staff.pengajuan.process', $pengajuan->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-surat\resources\views/dashboard/index.blade.php ENDPATH**/ ?>