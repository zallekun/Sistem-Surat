...
<div class="bg-white shadow-sm rounded-xl overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('admin.fakultas.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium transition">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <form method="GET" class="flex gap-4">
                    ...
                    <a href="<?php echo e(route('admin.fakultas.index')); ?>" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm font-medium">
            ...
            <?php if($fakultas->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $fakultas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($fakultas->firstItem() + $index); ?></td>
                                    <td class="px-6 py-4 text-sm">
                                        <span class="px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full font-mono text-xs font-semibold"><?php echo e($f->kode_fakultas); ?></span>
                                    </td>
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($f->nama_fakultas); ?></td>
                                    <td class="px-6 py-4 text-sm text-center">
                                        <span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-xs font-medium">
                                            <?php echo e($f->prodi()->count()); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="<?php echo e(route('admin.fakultas.edit', $f->id)); ?>" 
                                               class="px-3 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 text-xs font-medium">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('admin.fakultas.destroy', $f->id)); ?>"
                                                  method="POST"
                ...
                <div class="px-6 py-4 border-t">
                    <?php echo e($fakultas->appends(request()->query())->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-surat\resources\views/admin/master/fakultas/index.blade.php ENDPATH**/ ?>