...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Beranda'); ?> - Sistem Surat FSI</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <a href="<?php echo e(url('/')); ?>" class="flex items-center group">
                ...
                <nav class="hidden lg:flex items-center space-x-1">
                    ...
                    <a href="<?php echo e(route('public.pengajuan.create')); ?>" 
                       class="flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('public.pengajuan.*') ? 'text-blue-600 bg-blue-50 shadow-sm' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50'); ?>">
                        <i class="fas fa-plus-circle mr-2"></i>
                        Ajukan Surat
                    </a>
                    
                    <a href="<?php echo e(route('tracking.public')); ?>" 
                       class="flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('tracking.*') ? 'text-blue-600 bg-blue-50 shadow-sm' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50'); ?>">
            ...
            <div class="lg:hidden" x-show="mobileMenuOpen" 
                ...
                <div class="px-2 pt-2 pb-6 space-y-2 border-t border-gray-200 bg-white shadow-lg rounded-b-lg">
                    ...
                    <a href="<?php echo e(route('public.pengajuan.create')); ?>" 
                       class="flex items-center px-4 py-3 text-base font-medium rounded-lg transition-all <?php echo e(request()->routeIs('public.pengajuan.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50'); ?>"
                    ...
                    <a href="<?php echo e(route('tracking.public')); ?>" 
                       class="flex items-center px-4 py-3 text-base font-medium rounded-lg transition-all <?php echo e(request()->routeIs('tracking.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50'); ?>"
                       @click="mobileMenuOpen = false">
            ...
            <div class="border-t border-gray-200 pt-6 mt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p class="text-sm text-gray-500">
                        &copy; <?php echo e(date('Y')); ?> Universitas Jenderal Achmad Yani. Hak Cipta Dilindungi.
                    </p>
...
</html><?php /**PATH /home/rezal-suryadi-putra/Documents/KULIAH/SEMESTER 7/KP/sistem-surat/resources/views/layouts/public.blade.php ENDPATH**/ ?>