...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">
            <i class="fas fa-envelope mr-2"></i>Daftar Surat Fakultas - <?php echo e(Auth::user()->prodi->fakultas->nama_fakultas ?? 'Fakultas Sains dan Informatika'); ?>
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        <div class="px-4 py-5 sm:p-6">
            ...
            <div id="filterSection">
                <form method="GET" action="<?php echo e(route('fakultas.surat.index')); ?>" class="grid grid-cols-1 gap-4 sm:grid-cols-12">
                    <!-- Search Input -->
                    ...
                    <div class="sm:col-span-1 flex flex-col justify-end">
                        ...
                        <?php if(request()->hasAny(['search', 'prodi_id', 'type', 'status_id', 'tanggal_dari', 'tanggal_sampai'])): ?>
                            <a href="<?php echo e(route('fakultas.surat.index')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    <div class="flex items-center flex-wrap gap-2">
                        ...
                        <?php if(request('search')): ?>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['search' => null])); ?>" class="ml-1 text-blue-600 hover:text-blue-500">
                        ...
                        <?php if(request('prodi_id')): ?>
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                Prodi: <?php echo e($selectedProdi->nama_prodi ?? 'Unknown'); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['prodi_id' => null])); ?>" class="ml-1 text-green-600 hover:text-green-500">
                                    <i class="fas fa-times text-xs"></i>
                                </a>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if(request('type')): ?>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                Tipe: <?php echo e(ucfirst(request('type'))); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['type' => null])); ?>" class="ml-1 text-purple-600 hover:text-purple-500">
                                    <i class="fas fa-times text-xs"></i>
                                </a>
                            </span>
                        <?php endif; ?>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-1">
                        ...
                        <dd class="mt-1 text-2xl font-semibold text-gray-900"><?php echo e($paginationInfo->total ?? 0); ?></dd>
                    </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-1">
                        ...
                        <dd class="mt-1 text-2xl font-semibold text-green-900"><?php echo e($items->where('status_class', 'bg-green-100 text-green-800')->count()); ?></dd>
                    </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-1">
                        ...
                        <dd class="mt-1 text-2xl font-semibold text-red-900"><?php echo e($items->where('status_class', 'bg-red-100 text-red-800')->count()); ?></dd>
                    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($paginationInfo->from + $index); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <?php if($item->type === 'pengajuan'): ?>
                                <div class="text-blue-600 font-mono"><?php echo e($item->nomor_surat); ?></div>
                                <div class="text-xs text-gray-500">NIM: <?php echo e($item->original_pengajuan->nim ?? 'N/A'); ?></div>
                            <?php else: ?>
                                <div class="text-gray-900 font-mono"><?php echo e($item->nomor_surat); ?></div>
                                <?php if($item->created_at): ?>
                                    <div class="text-xs text-gray-500"><?php echo e($item->created_at->format('Y')); ?></div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <div class="max-w-xs truncate" title="<?php echo e($item->perihal); ?>">
                                <?php echo e($item->perihal); ?>

                            </div>
                            <?php if($item->type === 'pengajuan'): ?>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="font-medium"><?php echo e($item->nama_mahasiswa ?? 'N/A'); ?></span>
                                </div>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <div><?php echo e($item->createdBy->nama ?? $item->createdBy->name ?? 'N/A'); ?></div>
                            <?php if($item->type === 'surat' && isset($item->original_surat) && $item->original_surat->createdBy && $item->original_surat->createdBy->jabatan): ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($item->status_class); ?>">
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-gray-400 text-sm">
                                    <?php if(request()->hasAny(['search', 'prodi_id', 'type', 'status_id', 'tanggal_dari', 'tanggal_sampai'])): ?>
                                        ...
                                        <a href="<?php echo e(route('fakultas.surat.index')); ?>" class="text-indigo-600 hover:text-indigo-500">reset pencarian</a>
                                    <?php else: ?>
        ...
        <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Menampilkan 
                    <span class="font-medium"><?php echo e($paginationInfo->from); ?></span> 
                    sampai 
                    <span class="font-medium"><?php echo e($paginationInfo->to); ?></span> 
                    dari 
                    <span class="font-medium"><?php echo e($paginationInfo->total); ?></span> 
                    item
                </div>
                <div class="flex space-x-1">
                    ...
                    <?php for($i = max(1, $paginationInfo->current_page - 2); $i <= min($paginationInfo->last_page, $paginationInfo->current_page + 2); $i++): ?>
                        <a href="?page=<?php echo e($i); ?>&<?php echo e(http_build_query(request()->except('page'))); ?>" 
                           class="px-3 py-2 text-sm border rounded transition-colors <?php echo e($i == $paginationInfo->current_page ? 'bg-indigo-500 text-white border-indigo-500' : 'bg-white hover:bg-gray-50'); ?>">
                            <?php echo e($i); ?>
...
<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($item->type === 'surat' && $item->currentStatus->kode_status === 'disetujui_kaprodi'): ?>
    <!-- Approve Modal -->
    <div id="approveModal<?php echo e($item->id); ?>" class="fixed z-10 inset-0 overflow-y-auto hidden">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form action="<?php echo e(route('fakultas.surat.approve', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="bg-blue-50 p-4 rounded-md mb-4">
                            <p class="text-sm"><strong>Nomor:</strong> <?php echo e($item->nomor_surat); ?></p>
                            <p class="text-sm"><strong>Perihal:</strong> <?php echo e($item->perihal); ?></p>
                            <p class="text-sm"><strong>Prodi:</strong> <?php echo e($item->prodi->nama_prodi ?? 'N/A'); ?></p>
                        </div>
                        <div>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <button type="button" onclick="closeModal('approveModal<?php echo e($item->id); ?>')" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm transition-colors">
                            Batal
                        </button>
                    </div>
                </form>
    ...
    <!-- Reject Modal -->
    <div id="rejectModal<?php echo e($item->id); ?>" class="fixed z-10 inset-0 overflow-y-auto hidden">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form action="<?php echo e(route('fakultas.surat.reject', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex items-center mb-4">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <button type="button" onclick="closeModal('rejectModal<?php echo e($item->id); ?>')" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm transition-colors">
                            Batal
                        </button>
                    </div>
                </form>
