...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        <!-- Back Button -->
        <div class="mb-4">
            <a href="<?php echo e(route('fakultas.arsip.index')); ?>" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
                                            ...
                                            <div class="grid grid-cols-2 gap-3">
                                                <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subKey => $subValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-900 mt-1"><?php echo e(is_array($subValue) ? json_encode($subValue) : ($subValue ?? '-')); ?></p>
                                                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white/95 backdrop-blur-sm shadow-sm rounded-xl overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <a href="<?php echo e(route('fakultas.arsip.index')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-surat\resources\views/fakultas/arsip/show.blade.php ENDPATH**/ ?>